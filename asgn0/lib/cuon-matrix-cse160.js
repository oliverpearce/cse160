...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // if 2d, return the fish 
        else {
          let z = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];
          v3 = new Vector3([0, 0, z]);
        }
    ...
    magnitude() {
        ...
        if (!isNaN(this.elements[2])){
          m += Math.pow(this.elements[2], 2);
        }
        m = Math.sqrt(m);

        // console.log(this.elements[0], this.elements[1], this.elements[2], m)
